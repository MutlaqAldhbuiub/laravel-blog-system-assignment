...
:
            ...
            <form method="POST" action="{{ route('createPost') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="image_url" class="form-control right zaridRegularFont @error('image_url') is-invalid @enderror" id="image_url" value="{{ old('image_url') }}" required autocomplete="image_url" autofocus>
